...
@Component({
  selector: 'app-list-sanction-rec-employee',
 
  templateUrl: './list-sanction-rec-employee.component.html',
  styleUrl: './list-sanction-rec-employee.component.css'
})
export class ListSanctionRecEmployeeComponent {
